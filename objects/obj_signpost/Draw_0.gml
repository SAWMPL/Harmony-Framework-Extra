/// @description Draw 3D Sign
	...
	draw_sprite_ext(spr_signpost_static, min((global.object_timer / 4) mod 30, 7), floor(x) + 4 * dsin(angle), floor(y) - 31, max(dcos(angle), 0), 1, 0, c_white, 1);
	draw_sprite_ext(JetSprite, JetImageIndex, floor(x) + 4 * dsin(angle+180), floor(y) - 31, max(dcos(angle+180), 0), 1, 0, c_white, 1);
	...
	draw_sprite_ext(spr_signpost_static, min((global.object_timer / 4) mod 30, 7), floor(x) + 4 * dsin(angle+180), floor(y) - 31, max(dcos(angle+180), 0), 1, 0, c_white, 1);
